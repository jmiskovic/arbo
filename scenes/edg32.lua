...
{combine,
  ...
  {tint, {0.42, 0.42, 0.25}, {position, {0,0,30/count}, splat}}, -- moss
  {tint, {0.36, 0.38, 0.39}, {position, {0,0,29/count}, splat}}, -- flora
  {tint, {0.30, 0.52, 0.54}, {position, {0,0,28/count}, splat}}, -- light green
  {tint, {0.14, 0.99, 0.69}, {position, {0,0,27/count}, splat}}, -- sun yellow
  {tint, {0.10, 0.99, 0.60}, {position, {0,0,26/count}, splat}}, -- orange glow
  {tint, {0.07, 0.93, 0.55}, {position, {0,0,25/count}, splat}}, -- amber
  ...
  {tint, {0.01, 0.34, 0.34}, {position, {0,0,21/count}, splat}}, -- pine bark
  ...
  {tint, {0.05, 0.42, 0.59}, {position, {0,0,15/count}, splat}}, -- skin shade
  {tint, {0.07, 0.64, 0.75}, {position, {0,0,14/count}, splat}}, -- skin
  {tint, {0.99, 0.88, 0.71}, {position, {0,0,13/count}, splat}}, -- peach
